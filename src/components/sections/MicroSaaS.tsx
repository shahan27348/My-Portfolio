...
const StatusBadge: React.FC<{ status: string }> = ({ status }) => {
  const statusColors = {
    ...
    Planning: "bg-purple-500/20 text-purple-400 border-purple-500/50",
...
const MicroSaaSCard: React.FC<{
  ...
  return (
    <div className="group bg-navy-light rounded-lg overflow-hidden border border-slate-dark/50 hover:border-accent/50 transition-all duration-300">
      {/* Image */}
      {imageUrl && (
